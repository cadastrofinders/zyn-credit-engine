...
def get_sector_benchmarks(setor: str) -> dict[str, Any]:
    ...
    benchmarks = {
        "agro": {
            ...
            "garantias_tipicas": ["Alienacao Fiduciaria de Imovel Rural", "Penhor de Safra", "CDA/WA", "Aval dos Socios", "CPR como lastro", "Cessao Fiduciaria de Recebiveis"],
            "riscos_especificos": [
                ...
                "Grupo PF: endividamento disperso em multiplos CPFs — consolidar SCR + CPRs + IRPF",
                "Grupo PF: propriedades em condominio sem acordo de partilha formal",
                "Embargo IBAMA em area de garantia = impeditivo",
                "Protestos de fornecedores de insumos = red flag operacional",
            ],
            "kpis_agro_pf": {
                "divida_por_ha_produtiva_max": 15_000,
                "divida_receita_safra_max": 4.0,
                "cobertura_fundiaria_min": 1.5,
                "produtividade_vs_conab_min": 0.90,
                "pct_area_propria_bom": 0.30,
                "passivo_judicial_patrimonio_max": 0.20,
            },
            "notas": "Volume tipico ZYN: R$20-200MM (mediana ~R$40MM). Vinci/GCB sao investidores-chave. BB Gestao e Itau Asset sao maiores compradores CVM. Para Grupo PF: consolidar endividamento de todos os CPFs, verificar bureau/processos/protestos por integrante, checar ESG ambiental (IBAMA) e regularidade fundiaria (CAR/CCIR).",
        },
        "imobiliario": {
            "setor": "Imobiliario",
